...
- nightly-2026-09-11: the same native checks passed; rustc reported
  `1.100.0-nightly (67eda617e 2026-09-10)`.
...
- All 128 offline unit checks and the aggregate release validation passed.
